...
void main() {
  ...
  testWidgets('Navigate from HomePage to CounterPage',
    ...
    const Key counterPageButtonKey = Key(AppConstant.counterPageRoute);
    expect(find.byKey(counterPageButtonKey), findsOneWidget);

    // Tap on RaisedButton
    await tester.tap(find.byKey(counterPageButtonKey));
